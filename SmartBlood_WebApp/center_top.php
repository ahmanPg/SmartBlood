            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        ...
                        <li >
                            <a data-toggle="tab" href="#donations"><i class="fas fa-heart fa-lg"></i> Donations</a>
                        </li>
                        <li class="active" >
                            <a data-toggle="tab" href="#centers"><i class="fas fa-hospital fa-lg"></i> Centers</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#broadcast"><i class="fa fa-bullhorn fa-lg"></i> Broadcast</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#appointments"><i class="fa fa-bell-o fa-lg"></i>  Appoinments</a>
                        </li>
                        <li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="centers" class="tab-pane in active tab-custon-menu-bg animated flipInX">
                            <ul class="main-menu-dropdown">
