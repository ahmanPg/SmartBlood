...
<body>
  ...
  if(isset($_GET["error"])){
   ...
   require_once("connection/config.php");
    $str="SELECT donorID, donorNo, CONCAT(fname,' ',lname) as fullName, status, bloodType, weight, (YEAR(NOW())-YEAR(birthDate)) as age, phone, CONCAT(district,', ',province) as Address FROM users inner join donors on users.userID=donors.donorID";
    $query=$db->query($str) or die(mysqli_error());
    //$nrows=mysqli_num_rows($query); //PROCEAURAL
    $nrows=$query->num_rows; // OOP
    //echo $nrows;
    ?>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="donor_number">DonorCard No</th>
                                            <th data-field="name" data-editable="true">Name</th>
                                             <th data-field="tel">Tel</th>
                                            <th data-field="satus" data-editable="true">Status</th>
                                            <th data-field="gerou" data-editable="true">Group</th>
