...
<body>
  ...
  $donation="SELECT concat(fname,' ', lname) as fullName, phone, bloodType, COUNT(donationNo) as donationNumber from donation INNER JOIN donors ON donation.donorID=donors.donorID GROUP BY fullName";
                                                ...
                                                /*while($r=$query->fetch_array()){
                                                    ...
                                                    while($r=mysqli_fetch_array($result)){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $r["donationNumber"] ?></td>
