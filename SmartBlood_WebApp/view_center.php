											...
											/*while($r=$query->fetch_array()){
												...
												while($r=mysqli_fetch_array($query)){
													...
													<tr>
    													...
    													<td><?php echo $r["district"].', '.$r["province"] ?></td>
    													<td><a href="edit_center.php?edit_id=<?php  echo $r["centerName"] ?>"><i class="fa fa-edit fa-lg"></i></a></td>
    													<td><a onClick="javascript: return confirm('DO You want to delete')" href="delete_center.php?delete_id=<?php  echo $r["centerName"] ?>"><i class="fa fa-trash fa-lg"></i></a></td>
