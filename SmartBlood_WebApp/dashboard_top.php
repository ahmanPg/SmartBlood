            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        <li class="active">
                            <a data-toggle="tab" href="#home" ><i class="fa fa-home fa-lg" ></i> Home</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a data-toggle="tab" href="#donors"><i class="fa fa-users fa-lg"></i> Donors</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#reports"><i class="fas fa-file-medical-alt fa-lg"></i> Reports</a>
                        </li>
                    </ul>
