...
//    private static final String KEY_DONOR_PROFILE = "donor_profile";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        district = intent.getStringExtra(KEY_DISTRICT);
        group = intent.getStringExtra(KEY_GROUP_CHOICE);
    ...
    public class FetchDonorsAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "fetch_all_donors.php", "GET", httpParams);
            try {
