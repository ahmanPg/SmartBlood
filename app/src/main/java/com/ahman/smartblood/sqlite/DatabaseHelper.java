package com.ahman.smartblood.sqlite;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // Donor table column names
    private static final String COLUMN_DONOR_ID = COLUMN_USER_ID;
    ...
    public void addUser(User user) {
        ...
        values.put(COLUMN_SECURITY_QUESTION, user.getSecurityQuestion());
        values.put(COLUMN_SECURITY_ANSWER, user.getSecurityAnswer());
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setSecurityQuestion(cursor.getString(cursor.getColumnIndex(COLUMN_SECURITY_QUESTION)));
                user.setSecurityAnswer(cursor.getString(cursor.getColumnIndex(COLUMN_SECURITY_ANSWER)));
    ...
    public String checkUser(String email) {
        ...
        if (cursorCount > 0) {
            ...
            int indexNumber = cursor.getColumnIndex("user_name");
            String name = cursor.getString(indexNumber);
            return name;
        }
